...
module.exports = function (Aquifer) {
  ...
  .option('-e, --environment <environment>', 'The environment on which to invoke.')
  .action((name, options) => {
    ...
    // Set cwd parameter.
    spawnOpts.cwd = Aquifer.project.absolutePaths.build;
    ...
    run[method](script, spawnOpts, options.environment)
    .then(() => {
