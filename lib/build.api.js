  ...
  var Build = function(destination) {
    ...
    self.create = function (make, callback) {
      ...
      drush.init({log: true})
        ...
        // Generate database settings file.
        .then(buildStep('Generating database settings file...', function () {
          var settingsFile = path.join(Aquifer.project.absolutePaths.settings, 'db.settings.php'),
          ...
          contents.push('/**');
          contents.push(' * @file');
          contents.push(' * Database settings for this site.');
          contents.push(' * ');
          contents.push(' * This file is automatically generated from the database configuration in');
