  ...
  var Project = function(directory, name, configJsonPath) {
    ...
    self.absolutePaths = {
      ...
      files: {
        ...
        private: path.join(self.directory, self.config.paths.files.private)
      }
    };
    ...
    self.create = function(callback) {
      ...
      fs.mkdirSync(self.absolutePaths.files.private);
      ...
      touch.sync(path.join(self.absolutePaths.files.private, '.gitkeep'));
      ...
      fs.copySync(path.join(srcDir, 'files.htaccess'), path.join(self.absolutePaths.files.private, '.htaccess'));
