...
module.exports = function (Aquifer) {
  ...
  var Project = function(directory, name, configJsonPath) {
    ...
    self.absolutePaths = {
      ...
      coreFiles: path.join(self.directory, self.config.paths.coreFiles),
    ...
    self.create = function(callback) {
      ...
      fs.mkdirSync(self.absolutePaths.coreFiles);
      ...
      touch.sync(path.join(self.absolutePaths.coreFiles, '.gitkeep'));
      ...
      fs.copySync(path.join(srcDir, 'htaccess'), path.join(self.absolutePaths.coreFiles, '.htaccess'));
      fs.copySync(path.join(srcDir, 'robots.txt'), path.join(self.absolutePaths.coreFiles, 'robots.txt'));
