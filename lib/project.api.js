...
class Project {
  ...
  initialize(directory, name, configJsonPath) {
    return new Promise((resolve, reject) => {
      ...
      this.config.build.makeFile = this.config.paths.make || this.config.build.makeFile;
      this.config.build.directory = this.config.paths.build || this.config.build.directory;
