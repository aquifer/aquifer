...
class Project {
  ...
  create() {
    return new Promise((resolve, reject) => {
      ...
      fs.copySync(path.join(this.aquifer.allSrcDir, 'package.json'), path.join(this.directory, '.aquifer/package.json'));
      ...
      fs.copySync(path.join(this.srcDir, 'example.settings.local.php'), path.join(this.directory, 'settings/settings.local.php'));
