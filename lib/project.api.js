...
module.exports = function (Aquifer) {
  ...
  var Project = function(directory, name, configJsonPath) {
    ...
    self.create = function(callback) {
      ...
      // Copy over src files.
      fs.copySync(path.join(srcDir, 'example.settings.php'), path.join(self.absolutePaths.settings, 'example.settings.php'));
      fs.copySync(path.join(srcDir, 'example.db.settings.php'), path.join(self.absolutePaths.settings, 'example.db.settings.php'));
      fs.copySync(path.join(srcDir, 'example.secret.settings.php'), path.join(self.absolutePaths.settings, 'example.secret.settings.php'));
      fs.copySync(path.join(srcDir, 'example.local.settings.php'), path.join(self.absolutePaths.settings, 'example.local.settings.php'));
      fs.copySync(path.join(srcDir, 'README.md'), path.join(self.absolutePaths.settings, 'README.md'));
